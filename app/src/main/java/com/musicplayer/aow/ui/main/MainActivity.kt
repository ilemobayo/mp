...
import com.musicplayer.aow.ui.recorder.VoiceRecorderActivity
...
//        window.allowEnterTransitionOverlap
        ...
        name_playback = findViewById(R.id.text_view_name)
        artist_Playback = findViewById(R.id.text_view_artist)
...
//        fragmentTransaction?.replace(R.id.library_view_holder, fragment)
...
//                when (tab.position) {
//                    0 -> {
//                        changeFragments(tab.position.toString(), DiscoveryFragment())
//                    }
//                    1 -> {
//                        changeFragments(tab.position.toString(), AllSongsFragment())
//                    }
//                    2 -> {
//                        changeFragments(tab.position.toString(), AlbumFragment())
//                    }
//                    3 -> {
//                        changeFragments(tab.position.toString(), ArtistFragment())
//                    }
//                    4 -> {
//                        changeFragments(tab.position.toString(), PlayListsFragment())
//                    }
//                }
            }
...
//
//    fun changeFragments(tag: String, fragment: Fragment){
//        fragmentManager = supportFragmentManager
//        fragmentManager!!.findFragmentByTag(tag)
//        fragmentManager!!.beginTransaction()!!
//                .replace(R.id.library_view_holder, fragment, tag)
//                .addToBackStack(null)!!
//                .commit()
//    }
